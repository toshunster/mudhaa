...
class Product(models.Model):
    ...
    size_weight = models.CharField(max_length=60, blank = True, null = True, verbose_name="Size/weight")
    SKU = models.CharField(max_length=60, blank = True, null = True)
    brand = models.ForeignKey( Brand, blank = True, null = True )
    country = models.ForeignKey( Country, blank = True, null = True )
    manifacturere = models.CharField(max_length=60, blank = True, null = True)
